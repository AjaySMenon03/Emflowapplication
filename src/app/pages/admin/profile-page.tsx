...
export function ProfilePage() {
    const { user, session, staffRecord, setRole, businessId, hasOnboarded } = useAuthStore();
    ...
    const userInitial = (staffRecord?.name || user?.email || "U").charAt(0).toUpperCase();
        ...
        <div className="space-y-6 animate-fade-in max-w-2xl mx-auto">
            ...
            <Card>
                <CardContent className="flex flex-col items-center py-8 gap-4">
                    ...
                    >
                        <Avatar className={`h-28 w-28 ring-4 ring-primary/10 transition-all duration-300 ${!isUploadingAvatar && 'group-hover:ring-primary/30'}`}>
                            {avatarPreview ? (
                                <AvatarImage src={avatarPreview} alt="Profile photo" className={isUploadingAvatar ? 'opacity-50' : ''} />
                            ) : null}
                        ...
                        <div className={`absolute inset-0 flex items-center justify-center rounded-full bg-black/40 transition-opacity duration-200 ${isUploadingAvatar ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`}>
                            {isUploadingAvatar ? (
                    ...
                    <div className="text-center">
                        <p className="font-semibold text-foreground">{staffRecord?.name || "User"}</p>
